...
public class Charge {
	...
	private enum prioriteType{ZERO,UN,DEUX,TROIS,QUATRE,CINQ,SIX,SEPT,HUIT,NEUF};
	private enum etatActuelType{ON,OFF};
	private enum etatDefaultType{ON,OFF,PRECEDENT};
